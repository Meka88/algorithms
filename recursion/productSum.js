...
// their level of depth. The depth of a "special" array is how far nested it is. 
// For instance, the depth of [] is 1; the depth of the inner array in[[]] is 2;
// the depth of the innermost array in [[[]]] is 3. Therefore, the product sum of 
// [x, y] is x + y; the product sum of [x, [y, z]] is x + 2 * (y + z); the product
